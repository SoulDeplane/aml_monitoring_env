...
def grade_medium(
    ...
    # Disposition correctness (flag vs clear vs SAR)
    ...
    for acc_id, exp in expected.items():
        ...
        if exp_action == "clear" and acc_id in cleared_accounts:
            ...
            correct_dispositions += 0.5  # partial credit: flagged but didn't file SAR
    if total_accounts > 0:
        disposition_score = correct_dispositions / total_accounts
    # Evidence quality: breadth of investigation tools used
