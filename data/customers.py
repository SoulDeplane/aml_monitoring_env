...
COMPANY_NAMES = [
    "Meridian Trading Co",
    "Apex Global Ventures",
    "Silverstream Holdings",
    "Pacific Rim Exports",
    ...
    "Obsidian Group Ltd",
    "Emerald Isle Trading",
    "Titan Resources Inc",
    "Sapphire Coast Pty",
    "Nordic Star Holdings",
    "Red Rock Ventures",
    "Crystal Clear Services",
    "Pinnacle Investments",
    "Shadow Creek LLC",
    "Bright Future Foundation",
    "Oasis Development Co",
]
...
SHELL_COMPANY_NAMES = [
    ...
    "Horizon Asset Management Cayman",
    "Stellar Global Trading Seychelles",
    "Pinnacle Fiduciary Services",
]


def generate_customer_profiles(
    rng: random.Random, count: int = 25
    ...
    for i in range(count):
        ...
        if is_corporate:
            ...
            if is_suspicious and rng.random() < 0.5:
                ...
                business_type = rng.choice(
                    ["import_export", "consulting", "money_service_business"]
                )
            ...
            kyc_status = (
                rng.choice(["verified", "verified", "pending_review"])
                if is_suspicious
                else "verified"
            )
            ...
            country = (
                ...
                else rng.choice(NORMAL_COUNTRIES)
            )
            ...
            risk_level = (
                "high" if is_suspicious else rng.choice(["low", "low", "low", "medium"])
            )
        ...
        profiles[account_id] = {
            ...
            "expected_monthly_volume": _expected_volume(
                rng, account_type, business_type, is_suspicious
            ),
...
def _expected_volume(
    rng: random.Random, account_type: str, business_type: str | None, suspicious: bool
) -> Dict[str, Any]:
