...
# Business types for corporate accounts
BUSINESS_TYPES = [
...
# High-risk jurisdictions for AML
HIGH_RISK_COUNTRIES = [
...
def generate_customer_profiles(rng: random.Random, count: int = 25) -> Dict[str, Dict[str, Any]]:
    ...
    for i in range(count):
        ...
        is_suspicious = i < 8  # First 8 accounts have suspicious patterns
        ...
        if is_suspicious and rng.random() < 0.4:
            opened_days_ago = rng.randint(10, 90)  # Recently opened
        ...
        profiles[account_id] = {
            ...
            "is_pep": is_suspicious and rng.random() < 0.15,  # Politically Exposed Person
