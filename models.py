...
class AMLObservation(Observation):
    ...
    accounts_reviewed: int = Field(default=0, description="Number of accounts reviewed so far")
    total_accounts: int = Field(default=0, description="Total accounts to review")
